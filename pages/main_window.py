...
class MainWindow:
    """The top-level XMPS 2000 window that appears after launch."""
    ...
    def wait_for_visible(self, timeout=TIMEOUT_MED):
        ...
        # Option 1: By title (most reliable if you know it)
        win = self.app.window(title_re=".*XMPS.*2000.*", visible_only=False)
        
        # Option 2: If title is unknown, use class_name
        # win = self.app.window(class_name="YourMainWindowClass")
